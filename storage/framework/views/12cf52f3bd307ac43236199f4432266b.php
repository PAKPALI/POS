        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    <img src="<?php echo e(asset('hub/assets/img/logo.png')); ?>" alt="Profile" height="60">
                </div>
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('profil')); ?>">PROFIL <i class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
...
<!--end header--><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/partials/navbar.blade.php ENDPATH**/ ?>