...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="page-preloader">
			<img src="<?php echo e(asset('hub/assets/img/logo.png')); ?>" alt="Chargement...">
		</div>
		...
		<script src="<?php echo e(asset('hub/assets/js/vendor.min.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/js/app.min.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/plugins/jvectormap-next/jquery-jvectormap.min.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/plugins/jvectormap-content/world-mill.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/plugins/apexcharts/dist/apexcharts.min.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/js/demo/dashboard.demo.js')); ?>" type="9763b948d984f4be9ade72e9-text/javascript"></script>
		<script src="<?php echo e(asset('hub/assets/js/demo/pos-customer-order.demo.js')); ?>" type="c87805f60b464443bf38d728-text/javascript"></script>
		...
		<script src="<?php echo e(asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')); ?>" data-cf-settings="9763b948d984f4be9ade72e9-|49" defer></script>
...
</html><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/layouts/layout_sale.blade.php ENDPATH**/ ?>