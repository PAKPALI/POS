								...
								success: function (data){
									if (data.status)
									{
										Swal.fire({
											...
											window.location.replace("<?php echo e(route('user_login')); ?>");
										})
									}
								},
								error: function (data){
...
</html><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/layouts/layout.blade.php ENDPATH**/ ?>