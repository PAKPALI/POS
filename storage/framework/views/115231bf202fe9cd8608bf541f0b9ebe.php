...
<link href="<?php echo e(asset('hub/assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet">
...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('hub/assets/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>" type="a39dbf23fc02d8553cf0dcf0-text/javascript"></script>
    ...
    <script>
        $(function() {
            ...
            var Datatable = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('code.index')); ?>",
                columns: [
                    {data: 'id',name: 'id'},
                    {data: 'name',name: 'name'},
                    {data: 'code',name: 'code'},
            ...
            $('#add').submit(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('code.store')); ?>",
            ...
            $('body').on('click', '.editModal', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('code/code')); ?>/'+id+'/edit',
                    dataType: 'html',
            ...
            $('body').on('click', '.view', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('code/code')); ?>/'+id,
                    dataType: 'html',
                    success:function(result)
                    {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/code/index.blade.php ENDPATH**/ ?>