                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-6">
                                                    ...
                                                    <select name="product_id" id="product_id" class="form-select">
                                                        <option value="">Sélectionner un produit</option>
                                                        <?php $__currentLoopData = $Product->where('qte', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?> (<?php echo e($item->qte); ?>)</option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
    ...
    <script>
        $(function() {
            ...
            $('#remove').submit(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('inventory.remove')); ?>",
                    //enctype: 'multipart/form-data',
            ...
            $('#exportPdf').on('click', function(e){
                ...
                window.open("<?php echo e(route('inventory.export.pdf')); ?>?" + params, '_blank');
            });
        }); 
    </script>
