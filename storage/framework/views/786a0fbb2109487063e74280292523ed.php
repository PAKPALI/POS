    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.editModal', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('component/category')); ?>/'+id+'/edit',
                    dataType: 'html',
            ...
            $('body').on('click', '.view', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('component/category')); ?>/'+id,
                    dataType: 'html',
                    success:function(result)
                    {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/component/category/index.blade.php ENDPATH**/ ?>