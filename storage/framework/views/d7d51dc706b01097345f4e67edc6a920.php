                                        ...
                                        <div class="d-flex">
                                            <div class="position-relative mb-2">
                                                <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                    style="background-image: url(${product ? "<?php echo e(asset('images')); ?>/" + product.image : ''});">
                                                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/pos/sale/history.blade.php ENDPATH**/ ?>