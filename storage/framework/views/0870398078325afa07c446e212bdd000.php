...
<div class="row">
            ...
            <div class="card border-color mb-3">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($Category->count()); ?></h3>
                        </div>
                        <div class="col-5">
        ...
        <a href="<?php echo e(route('product.index')); ?>">
            <div class="card border-color mb-3">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($Product->count()); ?></h3>
                        </div>
                        <div class="col-5">
                            <div class="mt-n2" data-render="apexchart" data-type="bar" data-title="Visitors"
                                data-height="30"></div>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card border-color mb-3">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-2">
                    <div class="col-7">
                        <h3 class="mb-0"><?php echo e($Sale->count()); ?></h3>
                    </div>
                    <div class="col-5">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card border-color mb-3">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-2">
                    <div class="col-7">
                        <h3 class="mb-0"><?php echo e($sale_total_profit); ?> FCFA</h3>
                    </div>
                    <div class="col-5">
                        <div class="mt-n3 mb-n2" data-render="apexchart" data-type="bar"
                            data-title="Visitors" data-height="45"></div>
    ...
    <div class="col-xl-4">
        <div class="card mb-3">
            ...
            <div class="d-flex justify-content-center mt-3">
                <?php echo e($mostSoldProducts->links('pagination::bootstrap-4')); ?>
    ...
    <div class="col-xl-8">
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-borderless mb-2px small text-nowrap">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $Action; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?php echo e($action->function); ?></td>
                                    <td><span class="badge d-block bg-theme text-theme-900 rounded-0 pt-5px w-70px"style="min-height: 18px;">
                                        <?php echo e($action->user?$action->user->name:'-'); ?></span>
                                    </td>
                                    <td><?php echo e($action->user?$action->text:'-'); ?></td>
                                    <td><?php echo e($action->user?$action->created_at->format('d-m-Y H:i:s'):'-'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <div class="d-flex justify-content-center mt-3">
                <?php echo e($Action->links('pagination::bootstrap-4')); ?>
...
<script>
    $(function() {
        ...
        function updateChart() {
            ...
            fetch("<?php echo e(route('statistics.topProducts')); ?>", {
                method: "POST",
                headers: {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/dashboard.blade.php ENDPATH**/ ?>