    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.editModal', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('component/product')); ?>/'+id+'/edit',
                    dataType: 'html',
            ...
            $('body').on('click', '.view', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('component/product')); ?>/'+id,
                    dataType: 'html',
                    success:function(result)
                    {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/component/product/index.blade.php ENDPATH**/ ?>