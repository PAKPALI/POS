    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-12">
                ...
                <input type="text" name="name" class="form-control" id="name" value="<?php echo e($Category->name); ?>" placeholder="Nom">
            </div>
        </div>
    </div>
    ...
    $(function() {
        ...
        $('#submit').click(function(e) {
            ...
            $.ajax({
                ...
                url: '<?php echo e(url('component/category/' . $Category->id)); ?>',
                type: "PUT",
                dataType: 'json',
...
<?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/component/category/edit.blade.php ENDPATH**/ ?>