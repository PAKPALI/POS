            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    <div class="desktop-sticky-top">
                        ...
                        <div class="mb-3">
                            <i class="fa fa-link fa-fw text-inverse text-opacity-50"></i><?php echo e(config('app.name')); ?>
                                                        ...
                                                        <!-- <div class="list-group-item fw-bold px-3"> -->
                                                            ...
                                                            <form  id="updateEmail" class="p-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="email" class="form-control form-control-lg bg-inverse bg-opacity-5" name="AE" placeholder="email" value="<?php echo e(auth()->user()->email); ?>">
                                                                </div>
                                                                <div class="mb-3">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/user/profile.blade.php ENDPATH**/ ?>