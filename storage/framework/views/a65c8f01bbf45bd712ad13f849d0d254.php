    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.editModal', function () {
                var id = $(this).data("id");
                $.ajax({
                    url:'<?php echo e(url('user')); ?>/'+id+'/edit',
                    dataType: 'html',
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/user/index.blade.php ENDPATH**/ ?>