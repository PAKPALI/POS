<form id="update_form">
    ...
    <div class="card-body text-center">
         <?php if($Product->image): ?>
            <img class="mb-5" src="<?php echo e(asset('images/' . $Product->image)); ?>" alt="Image du produit" style="width: 150px; height: auto;">
        <?php else: ?>
            Pas d'image
        <?php endif; ?>
        <div class="row">
            ...
            <div class="form-group col-6 mb-3">
                ...
                <input type="text" name="name" value="<?php echo e($Product->name); ?>" class="form-control" id="exampleInputText0" placeholder="Nom">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputText0">Quantité</label>
                <input type="number" name="qte" value="<?php echo e($Product->qte); ?>" class="form-control" id="exampleInputText0" placeholder="0">
            </div>
            <div class="form-group col-6 mb-3">
        ...
        <div class="row mt-3">
            ...
            <div id="product-fields-container2">
                ...
                <?php $__currentLoopData = $MenuProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row product-field2">
                        <div class="form-group col-5 mb-2 mt-2">
                            ...
                            <select class="form-select mb-3 product-select2" name="products[]">
                                ...
                                <?php $__currentLoopData = $Products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->id); ?>" <?php echo e($product->id == $mp->product_id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group col-6 mb-2 mt-2">
                            <label for="exampleInputText0">Quantité</label>
                            <input type="number" name="quantities[]" value="<?php echo e($mp->quantity); ?>" class="form-control product-quantity2" placeholder="0">
                        </div>
...
<script>
    $(function() {
        ...
        $('#submit').click(function(e) {
            ...
            $.ajax({
                data: formData,
                url: '<?php echo e(url('component/menu/' . $Product->id)); ?>',
                type: "POST",
...
</script><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/component/menu/edit.blade.php ENDPATH**/ ?>