                ...
                <div class="pos-content-container h-100 p-4 text-center" data-scrollbar="true" data-height="100%">
                    ...
                    <div class="row gx-4 text-center" id="product_list">
                        ...
                        <div class="row sale_list mb-5">
                            ...
                            <div class="<?php echo e(auth()->user()->user_type==3?'col-xl-4':'col-xl-3'); ?> col-lg-6 ">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-2">
                                            <div class="col-7">
                                                <h3 class="mb-0"><?php echo e($Object->count()); ?></h3>
                                            </div>
                                            <div class="col-5">
                            ...
                            <div class="<?php echo e(auth()->user()->user_type==3?'col-xl-4':'col-xl-3'); ?> col-lg-6 ">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-2">
                                            <div class="col-7">
                                                <h3 class="mb-0"><?php echo e($product_count); ?></h3>
                                            </div>
                                            <div class="col-5">
                                                <div class="mt-n2" data-render="apexchart" data-type="bar" data-title="Visitors"
                                                    data-height="30"></div>
                            ...
                            <div class="<?php echo e(auth()->user()->user_type==3?'col-xl-4':'col-xl-3'); ?> col-lg-6 ">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-2">
                                            <div class="col-7">
                                                <h3 class="mb-0"><?php echo e($total_amount); ?></h3>
                                            </div>
                                            <div class="col-5">
                                                <div class="mt-n2" data-render="apexchart" data-type="bar" data-title="Visitors"
                                                    data-height="30"></div>
                                 ...
                                 <div class="<?php echo e(auth()->user()->user_type==3?'col-xl-4':'col-xl-3'); ?> col-lg-6 ">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center mb-2">
                                                <div class="col-7">
                                                    <h3 class="mb-0"><?php echo e($sale_total_profit); ?></h3>
                                                </div>
                                                <div class="col-5">
                                                    <div class="mt-n2" data-render="apexchart" data-type="bar" data-title="Visitors"
                                                        data-height="30"></div>
            ...
            <div class="pos-sidebar" id="pos-sidebar">
                <div class="h-100 d-flex flex-column p-0">
                    ...
                    <div class="pos-sidebar-header">
                        ...
                        <div class="title">Table de vente <marquee class="bg-dark"><?php echo e(Auth::user()->name); ?></marquee ></div>
                    ...
                    <div class="pos-sidebar-nav">
                        <ul class="nav nav-tabs nav-fill">
                            ...
                            <li class="nav-item nav-sale">
                                <a class="nav-link" href="#" data-bs-toggle="tab" data-bs-target="#orderHistoryTab">Produits vendus (<?php echo e($mostSoldProducts->count()); ?>)</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="pos-sidebar-body tab-content" data-scrollbar="true" data-height="100%">
                        <div class="tab-pane fade h-100 show active" id="newOrderTab">
                            <div class="pos-order">
                                <marquee class="bg-dark"><h2><?php echo e(Auth::user()->name); ?></h2></marquee >
                            </div>
                        ...
                        <div class="tab-pane fade h-100" id="orderHistoryTab">
                            <div class="h-100 d-flex align-items-top justify-content-center text-center p-20">
                                <div>
                                    ...
                                    <?php if($mostSoldProducts->count()>0): ?>
                                        <div class="col-12">
                                                        ...
                                                        <table class="w-100 mb-0 small align-middle text-nowrap">
                                                            <tbody>
                                                                <?php
                                                                    $n = 1;
                                                                ?>
                                                                <?php $__currentLoopData = $mostSoldProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex">
                                                                                <div class="position-relative mb-2">
                                                                                    <div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px"
                                                                                        style="background-image: url(<?php echo e(asset('images/' . $productDetail->product->image)); ?>);">
                                                                                    </div>
                                                                                    <div class="position-absolute top-0 start-0">
                                                                                        <span
                                                                                            class="badge bg-theme text-theme-900 rounded-0 d-flex align-items-center justify-content-center w-20px h-20px"><?php echo e($n++); ?></span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <td>
                                                                            <table class="mb-2">
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-inverse text-opacity-75 fw-500"><?php echo e($productDetail->total_quantity); ?></td>
                                                                                </tr>
                                                                                <!-- <tr>
                    ...
                    <div class="pos-sidebar-footer">
                        ...
                        <div class="mt-3">
                            <div class="btn-group d-flex">
                                ...
                                <?php if($company && $company->count() == 1): ?>
                                    <?php if(!$mainCash): ?>
                                        <div class="alert alert-danger text-center">
                                            ⚠️ Aucune caisse principale configurée !
                                        </div>
                                        <a href="<?php echo e(route('ams.settings')); ?>" class="btn btn-danger w-150px">
                                            Configurer
                                        </a>
                                    <?php elseif($setting && $setting->default_tax > 0 && !$taxCash): ?>
                                        <div class="alert alert-warning text-center">
                                            ⚠️ Taxe définie mais aucune caisse de taxe !
                                        </div>

                                        <a href="<?php echo e(route('ams.settings')); ?>" class="btn btn-warning w-150px">
                                            Configurer
                                        </a>
                                    <?php else: ?>
...
<script>
    $(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (codePromo.trim() !== "") {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('verifyPromo')); ?>",
                            data: {
                                code: codePromo,
                                _token: "<?php echo e(csrf_token()); ?>" // Protection CSRF Laravel
                            },
                            dataType: "json",
                            success: function(response) {
                                ...
                                Swal.fire({
                                    ...
                                    if (saleResult.isConfirmed) {
                                        ...
                                        $.ajax({
                                            url: '<?php echo e(route("sale.store")); ?>',
                                            type: 'POST',
                                            data: {
        ...
        var Datatable = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('sale.index')); ?>",
            columns: [
        ...
        $('body').on('click', '.view', function () {
            var id = $(this).data("id");
            $.ajax({
                url:'<?php echo e(url('pos/sale')); ?>/'+id,
                dataType: 'html',
...
<?php echo $__env->make('layouts.layout_sale', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\laragon\www\POS\resources\views/pos/sale/index.blade.php ENDPATH**/ ?>