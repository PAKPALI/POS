            ...
            <div class="card border-color mb-3 card-white-shadow">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($totalTransactions->count); ?></h3>
                            <span class="badge blink-badge">
                                <?php echo e(number_format($totalTransactions->total, 2, ',', ' ')); ?> F CFA
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card border-color mb-3 card-white-shadow">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($inTransactions->count); ?></h3>
                            <span class="badge blink-badge">
                                <?php echo e(number_format($inTransactions->total, 2, ',', ' ')); ?> F CFA
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card border-color mb-3 card-white-shadow">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($outTransactions->count); ?></h3>
                            <span class="badge blink-badge">
                                <?php echo e(number_format($outTransactions->total, 2, ',', ' ')); ?> F CFA
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card border-color mb-3 card-white-shadow">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-7">
                            <h3 class="mb-0"><?php echo e($transferTransactions->count); ?></h3>
                            <span class="badge blink-badge">
                                <?php echo e(number_format($transferTransactions->total, 2, ',', ' ')); ?> F CFA
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-color mb-3 card-white-shadow">
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col-12">
                            <h3 class="mb-0">
                                <?php echo e(number_format($netBalance, 2, ',', ' ')); ?> F CFA
                            </h3>
                                    ...
                                    <div class="col-md-6 mt-3" id="from_cash_div">
                                        ...
                                        <select name="from_cash_id" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $cashes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cash->id); ?>"><?php echo e($cash->name); ?> (<?php echo e(number_format($cash->balance, 2, ',', ' ')); ?> FCFA)</option>
...
<!-- SCRIPTS -->
<script src="<?php echo e(asset('hub/assets/plugins/datatables.net/js/dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('hub/assets/plugins/datatables.net-bs5/js/dataTables.bootstrap5.min.js')); ?>"></script>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\POS\resources\views/ams/transaction/index.blade.php ENDPATH**/ ?>