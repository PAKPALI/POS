...
- La page `Paramètres > Notifications` propose maintenant « Autoriser les e-mails » dans les deux catégories Ventes et Inventaire, au même niveau que WhatsApp et SMS. La route reste protégée par `notifications.manage`.
