        ...
        @isset($activeCompany)
            <div class="menu-item dropdown dropdown-mobile-full">
                <a href="#" data-bs-toggle="dropdown" class="menu-link" title="Changer d'entreprise">
                    ...
                    <div class="menu-text d-sm-block d-none">{{ $activeCompany->name }}</div>
                </a>
                <div class="dropdown-menu dropdown-menu-end me-lg-3 mt-1">
                    <div class="dropdown-header">Entreprise active</div>
                    <div class="dropdown-item-text fw-bold">{{ $activeCompany->name }}</div>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('companies.select') }}">Changer d'entreprise</a>
                </div>
            </div>
        @endisset
