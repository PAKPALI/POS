@php
    ...
    $navigationLogo = $navigationCompany?->logo ? asset($navigationCompany->logo) : asset('brand/maxanou-symbol.svg');
...
<div class="navigation-loader" id="navigationLoader" aria-hidden="true" aria-live="polite">
    <div class="navigation-loader-card" role="status" aria-label="Chargement de {{ $navigationName }}">
        <span class="navigation-loader-mark"><img src="{{ $navigationLogo }}" alt="" width="48" height="48" onerror="this.onerror=null;this.src='{{ asset('brand/maxanou-symbol.svg') }}';"></span>
