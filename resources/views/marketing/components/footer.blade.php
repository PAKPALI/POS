<footer class="marketing-footer">
    <div class="marketing-container marketing-footer-grid">
        ...
        <div><strong>Contact</strong><a href="mailto:{{ config('marketing.contact_email') }}"><i class="bi bi-envelope" aria-hidden="true"></i> {{ config('marketing.contact_email') }}</a><a href="tel:+22879685106"><i class="bi bi-telephone" aria-hidden="true"></i> +228 79 68 51 06</a><a href="{{ route('marketing.security') }}">Sécurité</a><a href="{{ route('marketing.help') }}">Aide</a><a href="{{ route('marketing.legal') }}">Mentions légales</a></div>
