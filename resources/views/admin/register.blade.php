...
@section('content')
    <div class="register">
        <div class="register-content p-2">
            <form action="https://seantheme.com/hud/index.html" method="POST" name="register_form">
                <h1 class="text-center">INSCRIPTION</h1>
                <p class="text-inverse text-opacity-50 text-center">APP-NAME</p>
                <div class="mb-3">
                    <label class="form-label">Nom <span class="text-danger">*</span></label>
                    <input type="text" class="form-control form-control-lg bg-inverse bg-opacity-5" placeholder="nom" value>
                </div>
                <div class="mb-3">
                    <label class="form-label">Email <span class="text-danger">*</span></label>
                    <input type="email" class="form-control form-control-lg bg-inverse bg-opacity-5" placeholder="email" value>
                </div>
                <div class="mb-3">
                    <label class="form-label">Mot de passe <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <input type="password" class="form-control form-control-lg bg-inverse bg-opacity-5" id="password" placeholder="mot de passe">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control form-control-lg bg-inverse bg-opacity-5" id="password2" placeholder="mot de passe">
