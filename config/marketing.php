...
return [
    ...
    'plans' => [
        [
            ...
            'currency' => 'XOF', 'company_limit' => 1, 'user_limit' => 1, 'product_limit' => 10, 'sms_quota' => 3, 'whatsapp_quota' => 3,
            'limits' => '1 entreprise · 1 utilisateur · 10 produits', 'quota' => '3 SMS · 3 WhatsApp / mois', 'suppliers' => true, 'ecommerce' => true,
            'featured' => false,
        ],
        [
            'key' => 'basic', 'name' => 'Basic', 'price' => 2500, 'annual' => 27500,
            'period' => 'mois', 'description' => 'Pour une activité qui démarre avec méthode.',
            'currency' => 'XOF', 'company_limit' => 1, 'user_limit' => 2, 'product_limit' => 50, 'sms_quota' => 10, 'whatsapp_quota' => 10,
            'limits' => '1 entreprise · 2 utilisateurs · 50 produits', 'quota' => '10 SMS · 10 WhatsApp / mois', 'suppliers' => false, 'ecommerce' => false,
            'featured' => false,
        ],
        [
            ...
            'limits' => '1 entreprise · 3 utilisateurs · 150 produits', 'quota' => '20 SMS · 20 WhatsApp / mois', 'suppliers' => true, 'ecommerce' => true,
            'featured' => true,
        ],
        [
            'key' => 'silver', 'name' => 'Argent', 'price' => 10000, 'annual' => 110000,
            'period' => 'mois', 'description' => 'Pour plusieurs activités à piloter ensemble.',
            'currency' => 'XOF', 'company_limit' => 2, 'user_limit' => 5, 'product_limit' => 500, 'sms_quota' => 50, 'whatsapp_quota' => 50,
            'limits' => '2 entreprises · 5 utilisateurs · 500 produits', 'quota' => '50 SMS · 50 WhatsApp / mois', 'suppliers' => true, 'ecommerce' => true,
            'featured' => false,
        ],
        [
            'key' => 'gold', 'name' => 'Gold', 'price' => 20000, 'annual' => 220000,
            'period' => 'mois', 'description' => 'Pour les équipes et réseaux en croissance.',
            'currency' => 'XOF', 'company_limit' => 5, 'user_limit' => 15, 'product_limit' => 1000, 'sms_quota' => 100, 'whatsapp_quota' => 100,
            'limits' => '5 entreprises · 15 utilisateurs · 1 000 produits', 'quota' => '100 SMS · 100 WhatsApp / mois', 'suppliers' => true, 'ecommerce' => true,
            'featured' => false,
        ],
    ],
    'pages' => [
        ...
        'partenaires' => [
            'eyebrow' => 'Le programme Partenaires Maxanou',
            'title' => 'Recommandez un outil utile. Construisez un revenu durable.',
            'intro' => 'Vous connaissez des commerçants qui veulent vendre avec plus de méthode ? Partagez Maxanou avec votre réseau et suivez la valeur créée par vos recommandations.',
            'sections' => [
                ['icon' => 'people', 'title' => 'Un code à votre nom', 'text' => 'Après votre inscription, vous disposez d’un code partenaire unique à partager dans vos conversations, groupes, formations ou rendez-vous commerciaux.'],
                ['icon' => 'percent', 'title' => 'Une offre claire pour votre réseau', 'text' => 'Votre recommandation peut ouvrir droit à 10 % de remise sur le premier abonnement payant éligible du nouveau client.'],
                ['icon' => 'wallet', 'title' => 'Des commissions suivies', 'text' => 'Quand un client est définitivement attribué après son premier paiement confirmé, les commissions sont enregistrées dans votre portefeuille selon les règles du programme.'],
                ['icon' => 'share', 'title' => 'Une méthode simple', 'text' => 'Présentez le besoin, partagez votre code, laissez le commerçant découvrir Maxanou et accompagnez-le jusqu’à sa première utilisation.'],
                ['icon' => 'chart', 'title' => 'Une relation dans la durée', 'text' => 'Le programme est pensé pour valoriser les clients réellement accompagnés : l’attribution est durable et les renouvellements suivent le taux acquis, selon les conditions applicables.'],
                ['icon' => 'shield', 'title' => 'Un cadre transparent', 'text' => 'Les règles de remise, de commission, de maturité et de retrait sont affichées et auditables. Aucune commission n’est créée sans paiement confirmé.'],
            ],
        ],
        'securite' => [
