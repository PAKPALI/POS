...
class EntitlementService
{
    ...
    public function feature(Company $company,string $feature): bool { if(!$this->enforcementEnabledFor($company))return true; $s=$this->current($company); if(!$s||!$s->ends_at->isFuture())return false; return (bool)($s->snapshot['features'][$feature] ?? false); }
